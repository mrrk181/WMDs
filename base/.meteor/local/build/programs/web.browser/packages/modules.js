...
install("ddp-rate-limiter");                                                 // 68
install("localstorage");                                                     // 69
install("callback-hook");                                                    // 70
install("jquery", "meteor/jquery/main.js");                                  // 71
...
install("audit-argument-checks");                                            // 80
install("browser-policy");                                                   // 81
install("fourseven:scss");                                                   // 82
install("aldeed:simple-schema");                                             // 83
install("raix:eventemitter");                                                // 84
install("aldeed:collection2-core");                                          // 85
install("aldeed:schema-index");                                              // 86
install("aldeed:schema-deny");                                               // 87
install("aldeed:collection2");                                               // 88
install("alanning:roles");                                                   // 89
install("spacebars");                                                        // 90
install("templating-compiler");                                              // 91
install("templating-runtime");                                               // 92
install("templating");                                                       // 93
install("fortawesome:fontawesome");                                          // 94
install("themeteorchef:bert");                                               // 95
install("static-html");                                                      // 96
install("xolvio:cleaner");                                                   // 97
install("xolvio:backdoor");                                                  // 98
install("mdg:validated-method");                                             // 99
install("dburles:factory");                                                  // 100
install("shell-server");                                                     // 101
install("webapp");                                                           // 102
...
install("mdg:validation-error");                                             // 108
                                                                             // 109
///////////////////////////////////////////////////////////////////////////////
